...
def create_sigma_agent(
    ...
    mitre_vectorstore: Optional[VectorStore] = None,
    ...
    toolkit = SigmaToolkit(sigmadb=sigma_vectorstore, mitredb=mitre_vectorstore, rule_creation_llm=rule_creation_llm)
    ...
    agent_executor = AgentExecutor(
        ...
        tools=tools,
        verbose=verbose,
        memory=agent_executor_kwargs.pop("memory"),
